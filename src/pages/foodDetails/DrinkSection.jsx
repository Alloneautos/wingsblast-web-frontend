...
const DrinkSection = ({ drinks, loading, error, onDrinkPriceChange,onDrinkSelected }) => {
    ...
    const handleSelectDrink = (drink) => {
        if (selectedDrink === drink) {
            ...
            onDrinkSelected(drink.drink_food_id);
        }
    };
    useEffect(() => {
        const price = selectedDrink ? selectedDrink.isPaid === 1 
                       ? selectedDrink.drink_price : 0 
                       : 0;
