  ...
  return (
    <div>
      ...
      <div className="w-full lg:w-8/12 mx-auto px-3 mt-5">
        ...
        <p>
          Absolutely! After selecting the location from which you'd like to
          order, you will see the option to select "Schedule Order" or "Order
        ...
        <p>
          No, you do not need to create an online order account. However,
        ...
        <p>
          Current order status is available by clicking "view status" in your
        ...
        <p>
          Account holders have the ability to cancel their order in the WINGS
          BLAST app or on
          <span className="text-green-600 underline"> WINGSBLAST.com</span> .
        </p>
        <p className="my-3">
          WINGS BLAST app and WINGS BLAST .com users will see an icon on the
          lower right side of the screen, click this icon to see options
          available. If the order hasn't been fully processed, the option to
          cancel will be displayed. If this option is not available, the order
          is unable to be canceled.
        </p>
        <p className="my-3">
        ...
        <div className="ml-10 lg:ml-24">
          <li>
            Proceed to the Quick Pick-up station at the front counter. Your
            order should be ready on the Quick Pick-up shelf.
          </li>
          <li>
            Head inside to pick up your order. Look for the label with your
        ...
        <p>
          Ensure you are downloading the app for WINGS BLAST in the US. If you
        ...
        <p>
          You can view your order history by clicking on the “account” icon on
        ...
        <p>
          You can update personal information by clicking on the “account” icon
          on the upper righthand corner of the screen, selecting “account
        ...
        <p>
          First, double-check to make sure your login information is correct. If
          you’re sure everything is correct, then hit the “Forgot?” button in
        ...
        <p>
          You can update personal information by clicking on the "account" icon
          on the upper righthand corner of the screen, selecting "Payment",
        ...
        <p>
          If there are any issues with your delivery order through
          wingsblast.com or the Wings Blast app, go to
          https://www.wingsblast.com/contact and choose your preferred method of
          contact. One of our guest care agents will be able to assist.
        </p>
        <p className="mt-5">
        ...
        <p>
          As a WINGS BLAST Rewards member, you automatically earn 10 points for
          every dollar spent on eligible product purchases with your Wings Blast
          Rewards account on WingsBlast.com or the Wings Blast app and can
          redeem those points for rewards in our Secret Recipe Vault. You’ll
          also have access to personalized oaers, member-only exclusives, and
          rotating challenges that make earning points even more fun – as well
        ...
        <p>
          Existing account holders can simply log in to their account on the
          wings blast app or wings blast.com and accept the new terms. To create
          a new account, download the Wings Blast app or visit wingsblast.com,
          navigate to the "Rewards" page, and click “Sign Me Up!” From there,
          provide your email address to receive an email with a unique login
        ...
        <p>
          Launch the Wings Blast app or visit wingsblast.com and ensure you are
          logged in. Navigate to the "Profile" page and then "My Info." From
        ...
        <p className="my-4">
          If you are opted into our marketing emails and you click on the
          unsubscribe link at the bottom of a marketing email, you will be opted
          out. You will still receive emailed receipts. You’re welcome to
          re-subscribe at any time!
        </p>
        <p>
          If you have a WINGS BLAST Rewards account, you can manage your
        ...
        <p>
          Yes. You’ll receive an email if any updates have been made to your
          account information, for security purposes. If you opted into Colonel
          Club emails, you will also receive updates on promotions and new menu
          items
        </p>
        <p className="my-4">
          When you place an order, you will not receive automatic text messages
          or push notifications regarding the status of your order. However,
          your delivery order tracking page will keep you updated on the status
          of your online order, such as when your food is being made and when
          it’s ready.
        </p>
        ...
        <p>
          Check your spam folder! Then be sure to save email@orders.wingsblast
        ...
        <p>
          f you have already checked your spam filter and you need a copy of
